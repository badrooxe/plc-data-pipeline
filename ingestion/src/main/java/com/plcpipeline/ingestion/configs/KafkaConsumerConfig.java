...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, TelemetryDataDto> telemetryConsumerFactory() {
        ...
        JsonDeserializer<TelemetryDataDto> jsonDeserializer = new JsonDeserializer<>(TelemetryDataDto.class);
        jsonDeserializer.addTrustedPackages("*"); // Allow all packages for deserialization
        jsonDeserializer.setRemoveTypeHeaders(false); // Tell it NOT to look for type headers, which we know won't be there.
